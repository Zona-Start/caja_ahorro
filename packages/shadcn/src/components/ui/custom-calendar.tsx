...
export const CustomCalendar = forwardRef<HTMLButtonElement, CustomCalendarProps>(
  (
    {
      value,
      onChange,
    ...
    // Generar años para el select (5 años atrás y 5 años adelante)
    const actualYear = new Date().getFullYear()
    const years = Array.from({ length: 11 }, (_, i) => actualYear - 5 + i)
    ...
    return (
      <Popover open={isOpen && !disabled} onOpenChange={disabled ? undefined : handleOpenChange}>
        ...
        <PopoverContent className={cn("w-auto p-4", popoverClassName)} align="start">
