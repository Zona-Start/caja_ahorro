Este documento establece los **estándares obligatorios** para el desarrollo de módulos en la aplicación web. Cualquier agente de IA o desarrollador debe seguir esta guía para garantizar consistencia, reactividad nativa, escalabilidad y mantenibilidad.
