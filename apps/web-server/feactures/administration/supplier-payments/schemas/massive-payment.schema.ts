import { z } from 'zod';
import { paymentAccountPayableSchema } from './account-payable.schema';
import { PaymentMethodEnum } from './supplier-payment-options';

export const massivePaymentAccountSchema = paymentAccountPayableSchema.extend({
  selected: z.boolean(),
...
export type CreateSupplierPaymentDto = z.infer<
  typeof CreateSupplierPaymentDtoSchema
>;
