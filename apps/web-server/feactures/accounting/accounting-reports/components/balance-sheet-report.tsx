...
import { BalanceSheetAccount } from '../schemas/balance-sheet.schema';
...
export function BalanceSheetReport() {
  ...
  const renderAccount = (account: BalanceSheetAccount) => {
    return (
      <Fragment key={account.accountCode}>
        ...
        {account.children && account.children.length > 0 && (
          <div className="pl-0">
            {account.children.map((child: BalanceSheetAccount) =>
              renderAccount(child),
            )}
          </div>
        )}
