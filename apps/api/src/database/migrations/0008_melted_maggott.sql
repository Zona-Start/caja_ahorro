ALTER TYPE "public"."associate_movement_type_enum" ADD VALUE 'LIQUIDATION_LOAN_PAYMENT_DEBIT';--> statement-breakpoint
ALTER TYPE "public"."associate_movement_type_enum" ADD VALUE 'LIQUIDATION_COMMERCIAL_CREDIT_PAYMENT_DEBIT';--> statement-breakpoint
ALTER TYPE "public"."associate_movement_type_enum" ADD VALUE 'LIQUIDATION_SPECIAL_LOAN_PAYMENT_DEBIT';--> statement-breakpoint
ALTER TYPE "public"."associate_movement_type_enum" ADD VALUE 'LIQUIDATION_SPECIAL_CREDIT_PAYMENT_DEBIT';--> statement-breakpoint
