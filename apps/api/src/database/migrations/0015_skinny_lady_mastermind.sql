...
CREATE TYPE "public"."module_code" AS ENUM('ACCOUNTING', 'LOANS', 'CREDITS', 'SAVINGS', 'INVENTORY', 'PURCHASING', 'SALES', 'BANKING', 'TREASURY', 'HR_PAYROLL', 'AUDIT', 'IAM', 'SYSTEM');--> statement-breakpoint
