...
CREATE TABLE "core"."company" (
	...
	"phone" varchar(50),
	"email" varchar(100),
	"base_currency_code" "currency_code_enum" DEFAULT 'VES' NOT NULL,
	"contact_person" text,
...
--> statement-breakpoint
CREATE TABLE "savings_banks"."transaction_type" (
	"id" serial PRIMARY KEY NOT NULL,
	"code" varchar(10) NOT NULL,
	"description" text NOT NULL,
...
ALTER TABLE "savings_banks"."transaction_type" ADD CONSTRAINT "transaction_type_employer_account_account_plan_id_fk" FOREIGN KEY ("employer_account") REFERENCES "accounting"."account_plan"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "savings_banks"."transaction_type" ADD CONSTRAINT "transaction_type_loan_account_account_plan_id_fk" FOREIGN KEY ("loan_account") REFERENCES "accounting"."account_plan"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "savings_banks"."transaction_type" ADD CONSTRAINT "transaction_type_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "auth"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "savings_banks"."transaction_type" ADD CONSTRAINT "transaction_type_updated_by_id_users_id_fk" FOREIGN KEY ("updated_by_id") REFERENCES "auth"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
