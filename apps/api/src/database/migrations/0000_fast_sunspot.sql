...
CREATE TYPE "public"."associate_movement_type_enum" AS ENUM('SAVING_CONTRIBUTION', 'EMPLOYER_CONTRIBUTION', 'DIVIDEND_CREDIT', 'LOAN_DISBURSEMENT_CREDIT', 'OTHER_CREDIT', 'SAVING_WITHDRAWAL', 'LOAN_PAYMENT_DEBIT', 'FEE_DEBIT', 'OTHER_DEBIT', 'ADJUSTMENT_CREDIT', 'ADJUSTMENT_DEBIT');--> statement-breakpoint
...
CREATE TABLE "banking"."bank_accounts" (
	...
	CONSTRAINT "bank_accounts_linked_chart_account_id_unique" UNIQUE("linked_chart_account_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "core"."type_operations" (
	"id" serial PRIMARY KEY NOT NULL,
	"code" varchar(10) NOT NULL,
	"description" text NOT NULL,
...
CREATE TABLE "savings_banks"."associate_account_movements" (
	...
	"movement_sign" integer NOT NULL,
	"currency_code" "currency_code_enum" NOT NULL,
	...
	"amount_base_currency" numeric(18, 2),
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp (3),
	"created_by_id" integer,
	"updated_by_id" integer
...
ALTER TABLE "core"."type_operations" ADD CONSTRAINT "type_operations_associated_account_account_plan_id_fk" FOREIGN KEY ("associated_account") REFERENCES "accounting"."account_plan"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "core"."type_operations" ADD CONSTRAINT "type_operations_employer_account_account_plan_id_fk" FOREIGN KEY ("employer_account") REFERENCES "accounting"."account_plan"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "core"."type_operations" ADD CONSTRAINT "type_operations_loan_account_account_plan_id_fk" FOREIGN KEY ("loan_account") REFERENCES "accounting"."account_plan"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "core"."type_operations" ADD CONSTRAINT "type_operations_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "auth"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "core"."type_operations" ADD CONSTRAINT "type_operations_updated_by_id_users_id_fk" FOREIGN KEY ("updated_by_id") REFERENCES "auth"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "savings_banks"."associate_account_movements" ADD CONSTRAINT "associate_account_movements_accounting_entry_id_accounting_entries_id_fk" FOREIGN KEY ("accounting_entry_id") REFERENCES "accounting"."accounting_entries"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "savings_banks"."associates" ADD CONSTRAINT "associates_payroll_type_id_category_types_id_fk" FOREIGN KEY ("payroll_type_id") REFERENCES "core"."category_types"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "savings_banks"."associates" ADD CONSTRAINT "associates_worker_type_id_category_types_id_fk" FOREIGN KEY ("worker_type_id") REFERENCES "core"."category_types"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "savings_banks"."loans" ADD CONSTRAINT "loans_loan_type_id_type_operations_id_fk" FOREIGN KEY ("loan_type_id") REFERENCES "core"."type_operations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "assoc_acct_mov_acct_entry_idx" ON "savings_banks"."associate_account_movements" USING btree ("accounting_entry_id");--> statement-breakpoint
...
CREATE INDEX "associates_worker_type_idx" ON "savings_banks"."associates" USING btree ("worker_type_id");--> statement-breakpoint
