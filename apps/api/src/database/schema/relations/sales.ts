...
export const customerPaymentApplicationsRelations = relations(
  customerPaymentApplications,
  ({ one }) => ({
    payment: one(customerPayments, {
      fields: [customerPaymentApplications.paymentId],
...
export const salesDeliveryNotesRelations = relations(
  salesDeliveryNotes,
  ({ one, many }) => ({
    customer: one(customers, {
...
export const salesDeliveryNoteItemsRelations = relations(
  salesDeliveryNoteItems,
  ({ one }) => ({
...
export const customersDeliveryNotesRelations = relations(
  customers,
  ({ many }) => ({
...
export const salesOrdersDeliveryNotesRelations = relations(
  salesOrders,
  ({ many }) => ({
    deliveryNotes: many(salesDeliveryNotes),
  }),
...
export const salesInvoicesDeliveryNotesRelations = relations(
  salesInvoices,
  ({ one }) => ({
    deliveryNote: one(salesDeliveryNotes, {
