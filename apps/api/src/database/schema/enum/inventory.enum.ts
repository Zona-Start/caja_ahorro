...
export const movementTypeInventoryEnum = inventorySchema.enum('movement_type_inventory', [
 ...
 */
export const inventoryMovementStatusEnum = inventorySchema.enum('inventory_movement_status', [
