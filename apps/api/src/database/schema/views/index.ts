...
// import { authSchema } from '../tables/auth';
// import { states } from '../tables/core';
// import { inventoryMovements, inventorySchema } from '../tables/inventory';
// import {
//   accountsPayable,
//   purchaseOrders,
//   supplierAdvances,
...
// export const associateAccountBalances = savingsSchema
...
// //proveedores vistas
// // purchasesSchema/views/supplierMaster360.ts
// export const supplierMaster360 = purchasesSchema.view('supplier_master_360', {
...
// export const supplierPurchases360 = purchasesSchema.view(
...
// //cuentas por pagar
// export const supplierAp360 = purchasesSchema.view('supplier_ap_360', {
//   supplierId: integer('supplier_id').notNull(),
...
// //advances
// export const supplierAdvances360 = purchasesSchema.view(
...
// export const supplierNotes360 = purchasesSchema.view('supplier_notes_360', {
//   supplierId: integer('supplier_id').notNull(),
...
// //pagos
// export const supplierPayments360 = purchasesSchema.view(
...
// export const supplierTotal360 = purchasesSchema.view('supplier_total_360', {
//   supplierId: integer('supplier_id').notNull(),
//   companyId: integer('company_id').notNull(),
//   code: varchar('code', { length: 50 }).notNull(),
//   name: varchar('name', { length: 255 }).notNull(),
