...
export const CAJA_AHORRO_TEMPLATE: BusinessTypeTemplate = {
  ...
  settings: [
    ...
    {
      key: 'INTEREST_RATE_SAVINGS',
      value: '0.5',
      description: 'Tasa de interés anual para ahorros (%)',
      category: 'savings',
    },
    {
      key: 'MAX_WITHDRAWAL_PERCENTAGE',
      value: '80',
      description: 'Porcentaje máximo de retiro sobre saldo',
      category: 'savings',
    },
    {
    ...
    },
    {
      ...
      value: '1',
      description: 'Monto mínimo de aporte',
      category: 'savings',
    },
    {
  ...
  moduleSettings: [
    ...
    },
    {
      module: 'savings',
      submodule: 'withdrawals',
      key: 'AUTO_POST_ENTRY_WITHDRAWALS',
      value: 'true',
    ...
    },
    {
      module: 'savings',
      submodule: 'contributions',
      key: 'AUTO_POST_ENTRY_CONTRIBUTIONS',
      value: 'true',
    ...
    },
    {
      ...
      key: 'DES-SOC',
      value: '0',
      description: 'Consecutivo Desembolsos Socios',
    },
    {
      module: 'savings',
      submodule: 'contributions',
      key: 'DES-LOT-SOC',
      value: '0',
      description: 'Consecutivo Lote Desembolsos Socios',
    },
    {
      module: 'savings',
    ...
    },
    {
      module: 'portfolio',
      submodule: 'credits',
      key: 'AUTO_POST_ENTRY_CREDITS_PAYMENT',
      value: 'true',
    ...
    },
    {
      module: 'portfolio',
      submodule: 'loans',
      key: 'AUTO_POST_ENTRY_LOANS_PAYMENT',
      value: 'true',
