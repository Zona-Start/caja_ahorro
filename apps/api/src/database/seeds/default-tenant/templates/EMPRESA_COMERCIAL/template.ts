...
export const EMPRESA_COMERCIAL_TEMPLATE: BusinessTypeTemplate = {
  ...
  settings: [
    { key: 'TAX_SALES', value: '16', description: 'Porcentaje de IVA para Ventas', category: 'inventory' },
    { key: 'TAX_PURCHASES', value: '16', description: 'Porcentaje de IVA para Compras', category: 'inventory' },
    ...
    { key: 'BILLING_DUE_DAYS', value: '30', description: 'Días de crédito por defecto en facturación', category: 'sales' },
    { key: 'PRICING_CURRENCY_MODE', value: 'MULTI_CURRENCY', description: 'Tipo de Manejo de inventario', category: 'inventory' },
