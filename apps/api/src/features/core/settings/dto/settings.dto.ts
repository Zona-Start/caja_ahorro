...
export class CreateGlobalSettingDto extends createZodDto(
  CreateGlobalSettingSchema,
) {}
export class UpdateGlobalSettingDto extends createZodDto(
...
export class CreateModuleSettingDto extends createZodDto(
  CreateModuleSettingSchema,
) {}
export class UpdateModuleSettingDto extends createZodDto(
  UpdateModuleSettingSchema,
) {}
