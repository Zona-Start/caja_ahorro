...
export enum AssociateMovementTypeEnum {
  ...
  LIQUIDATION_LOAN_PAYMENT_DEBIT = 'LIQUIDATION_LOAN_PAYMENT_DEBIT', // Pago de préstamo regular durante liquidación
  LIQUIDATION_CREDIT_PAYMENT_DEBIT = 'LIQUIDATION_CREDIT_PAYMENT_DEBIT', // Pago de crédito  durante liquidación
  LIQUIDATION_COMMERCIAL_CREDIT_PAYMENT_DEBIT = 'LIQUIDATION_COMMERCIAL_CREDIT_PAYMENT_DEBIT', // Pago de crédito comercial durante liquidación
  LIQUIDATION_SPECIAL_LOAN_PAYMENT_DEBIT = 'LIQUIDATION_SPECIAL_LOAN_PAYMENT_DEBIT', // Pago de préstamo especial durante liquidación
  LIQUIDATION_SPECIAL_CREDIT_PAYMENT_DEBIT = 'LIQUIDATION_SPECIAL_CREDIT_PAYMENT_DEBIT', // Pago de crédito especial durante liquidación
}
