  ...
  useEffect(() => {
    ...
    if (preloadedData) {
      ...
      initialValues = {
        ...
        paymentDescription:
          preloadedData.paymentDescription ||
          `Pago Factura ${accountPayable.supplierInvoice?.invoiceNumber}`,
      };
    } else {
      ...
      initialValues = {
        ...
        paymentMethod: PaymentMethodEnum.BANK_TRANSFER,
        transactionDate: new Date(),
        paymentDescription: `Pago Factura ${accountPayable.supplierInvoice?.invoiceNumber}`,
