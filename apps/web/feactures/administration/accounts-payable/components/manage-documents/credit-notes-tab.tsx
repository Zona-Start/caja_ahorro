...
import { useSupplierTransactionsNoteCredit } from '../../hooks/use-query-manager-documents';
import { columnsCreditNotes } from './columns-credit-notes';
...
export function CreditNotesTab() {
  ...
  const { data, isLoading, isError } = useSupplierTransactionsNoteCredit();
