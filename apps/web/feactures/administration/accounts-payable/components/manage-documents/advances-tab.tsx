...
import { useSupplierTransactionsAdvance } from '../../hooks/use-query-manager-documents';
import { columnsAdvances } from './columns-advances';
...
export function AdvancesTab() {
  ...
  const { data, isLoading, isError } = useSupplierTransactionsAdvance();
