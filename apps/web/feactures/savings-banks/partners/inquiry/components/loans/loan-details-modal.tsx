...
import { useLoanDetails } from '../../hooks/use-inquiry-queries';
import {
  LOAN_STATUS_TYPES,
  PAYMENT_LOAN_STATUS,
...
export function LoanDetailsModal({
  ...
  const { data, isLoading, isError } = useLoanDetails(loanId, {
    enabled: open,
  });
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[1000px]">
        ...
        <div className="px-6 pb-4">
          ...
          {isError && <p>Error al cargar los detalles del préstamo.</p>}
