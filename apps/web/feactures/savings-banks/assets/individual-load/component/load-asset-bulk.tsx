...
import { bulkFormSchema, BulkLoadAsset } from '../schemas/individual-load-schema';
...
export function LoadAssetsBulk() {
  ...
  const onSubmit = (data: BulkLoadAsset) => {
    if (!selectedFile) {
      toast.error({
  ...
  return (
    <>
      ...
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Seleccione el archivo y complete los datos bancarios del depósito unificado
        </CardDescription>
      </CardHeader>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-4 border rounded-lg p-5 bg-muted/20">
                <div className="flex flex-col gap-1 pb-3 border-b border-muted">
                  <h3 className="text-sm font-bold text-primary uppercase">Datos Bancarios del Depósito</h3>
