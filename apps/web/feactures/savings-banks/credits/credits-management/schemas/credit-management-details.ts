...
export const creditManagementDetailSchema = z.object({
  ...
  creditTypeInterestRate: z.string(),
  creditTypeTermUnits: z.string(),
});

export type CreditManagementDetails = z.infer<
  typeof creditManagementDetailSchema
>;
