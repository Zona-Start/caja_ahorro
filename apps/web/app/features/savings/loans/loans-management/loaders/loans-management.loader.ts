...
export const loansManagementLoader =
  ...
  async ({ request }: ClientLoaderFunctionArgs) => {
    ...
    return await queryClient.ensureQueryData({
      queryKey: QUERY_KEYS.loansManagement.list(JSON.stringify(filters)),
      queryFn: () => loansManagementService.getLoansManagementAll(filters),
    });
  };
