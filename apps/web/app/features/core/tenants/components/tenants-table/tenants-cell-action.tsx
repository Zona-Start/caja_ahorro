...
export function TenantsCellAction({ data }: TenantsCellActionProps) {
  ...
  return (
    <>
      <AlertModal
        ...
        loading={loading}
        title="¿Estás seguro de desactivar este tenant?"
        description="El tenant será marcado como inactivo. Esta acción puede revertirse."
      />
