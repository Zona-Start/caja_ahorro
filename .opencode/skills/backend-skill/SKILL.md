---
name: backend-skill
description: Este documento define la **Fuente de Verdad** para la arquitectura del Backend del proyecto **Zona Start**. Establece las reglas de diseño para NestJS y Drizzle ORM, asegurando que cualquier agente de IA o desarrollador mantenga la integridad del modelo **SaaS Multi-tenant**.
---
